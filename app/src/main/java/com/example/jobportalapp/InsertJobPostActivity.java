...
public class InsertJobPostActivity extends AppCompatActivity {
        ...
        private DatabaseReference mPublicDatabsse;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPublicDatabsse=FirebaseDatabase.getInstance().getReference().child("Public databse");
    ...
    private void InsertJob(){
        ...
        btn_post_job.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mPublicDatabsse.child(id).setValue(data);
